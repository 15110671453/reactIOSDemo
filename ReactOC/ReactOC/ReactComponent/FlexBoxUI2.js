...
let FlexBoxUI2 = React.createClass({
	...
	render: function () {
		return (
				...
				<View style = {styles.container}>
					...
					<Text onPress={this.ontextPress1}>View1{'\n'}
					我要返回 	我要返回	我要返回	我要返回	我要返回
						我要返回	我要返回	我要返回	我要返回	我要返回	我要返回	我要返回
					</Text>
